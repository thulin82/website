...
Ansökningar per område {#omrade-distans}
------------------------------------------------------------
...
Tre lärosäten har valt fokus på Webbprogrammering. Uppsala (Gotland) och Linné satsat på två-åriga program medans BTH har valt ett tre-årigt program.
