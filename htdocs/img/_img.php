...
// Append ending slash
$cimageClassFile = '/usr/home/mos/htdocs/dbwebb.se/img/cimage_/CImage.php';
$pathToImages = __DIR__;
//$pathToImages = __DIR__.'/img/';
$pathToCache = __DIR__.'/cache_/';
...
is_null($newWidth) or ($newWidth > 10 && $newWidth < 2000) or errorPage('Width out of range.');
is_null($newHeight) or ($newHeight > 10 && $newHeight < 2000) or errorPage('Hight out of range.');
