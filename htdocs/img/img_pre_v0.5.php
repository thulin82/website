...
// Append ending slash
$cimageClassFile  = __DIR__.'/../../cimage/latest/CImage.php'; // Where is the class file
$pathToImages     = __DIR__;       // Where are the image base directory
$pathToCache      = __DIR__.'/../../cimage/cache/okt13/';     // Where is the cache directory
$gridColumnWidth = 30;
$gridGutterWidth = 10;
$gridColumns     = 24;
